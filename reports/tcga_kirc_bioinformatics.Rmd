...
cat("\\centering\n")
cat("\\caption{Principales paquetes utilizados en el flujo de trabajo y sus versiones instaladas.}\n")
cat("\\label{tab:software-packages}\n")
...
bioinformatics_workflow_latex <- sub(
  "(\\\\caption\\{[^}]*\\})",
  "\\1\n\\\\label{tab:bioinformatics-workflow}",
