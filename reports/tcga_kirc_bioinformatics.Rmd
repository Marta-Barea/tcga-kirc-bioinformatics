...
```{r continuous-descriptive-plots, fig.width=8.5, fig.height=7.5, fig.align='center', out.width='90%', out.height='0.9\\textheight', fig.pos='p', fig.cap='Distribución de las variables continuas del conjunto de datos clínico TCGA-KIRC representada mediante diagrama de violín.'}
# Cargar librerías necesarias
library(ggplot2)
library(dplyr)
library(tidyr)
