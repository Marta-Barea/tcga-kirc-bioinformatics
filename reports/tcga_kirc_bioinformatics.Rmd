---
title: "Aplicación de herramientas bioinformáticas al estudio del carcinoma renal de células claras"
...
if (is.null(default_chunk_hook)) {
  default_chunk_hook <- function(x, options) x
}

escape_latex_code_text <- function(text) {
...
strip_trailing_code_period <- function(text) {
  sub("[[:space:]]*\\.+$", "", text)
}

code_titles <- c(
  "gdc-exploration-code" = "Exploracion inicial del proyecto TCGA-KIRC en el portal GDC.",
  "download-script-command" = "Comando de ejecucion del script de descarga y preparacion de datos.",
  "download-script-preview" = "Contenido del script de descarga y preparacion de datos TCGA-KIRC.",
  "data-directory-summary-code" = "Resumen estructural del directorio de datos del proyecto.",
  "clinical-data-glimpse-code" = "Inspeccion inicial del conjunto de datos clinicos preparado.",
  "missingness-heatmap-theme" = "Definicion del tema grafico del mapa de calor de valores faltantes.",
  "missingness-heatmap-code" = "Construccion de los datos y del grafico base del mapa de calor de valores faltantes.",
  "missingness-heatmap-figure" = "Representacion del mapa de calor de valores faltantes del conjunto clinico.",
  "missingness-treatment-code" = "Filtrado de variables clinicas con alto porcentaje de valores faltantes.",
  "missingness-summary-code" = "Resumen del porcentaje de valores faltantes tras el filtrado inicial.",
  "administrative-filtering-code" = "Eliminacion de variables administrativas y metadatos no relevantes.",
  "low-variance-filtering-code" = "Filtrado de variables clinicas con varianza nula o casi nula.",
  "redundant-vars-code" = "Deteccion de variables clinicas exactamente redundantes.",
  "redundant-filtering-code" = "Eliminacion de variables clinicas redundantes.",
  "missing-data-treatment-code" = "Recodificacion e imputacion dirigida de valores faltantes residuales.",
  "categorical-descriptive-statistics" = "Calculo de la estadistica descriptiva de las variables categoricas.",
  "categorical-descriptive-plots-setup" = "Preparacion de las graficas descriptivas para variables categoricas.",
  "categorical-descriptive-plot" = "Representacion grafica de las variables categoricas del conjunto clinico.",
  "continuous-descriptive-statistics" = "Calculo de la estadistica descriptiva de las variables continuas.",
  "continuous-descriptive-plots" = "Preparacion de los diagramas de violin para variables continuas.",
  "continuous-descriptive-plots-figure" = "Representacion grafica de las variables continuas del conjunto clinico.",
  "age-ajcc-assumptions-normality-homogeneity" = "Comprobacion de normalidad y homocedasticidad de la edad por estadio AJCC.",
  "age-ajcc-kruskal-wallis" = "Prueba de Kruskal-Wallis para edad al diagnostico segun estadio AJCC.",
  "age-tumor-grade-assumptions-normality-homogeneity" = "Comprobacion de normalidad y homocedasticidad de la edad por grado tumoral.",
  "age-tumor-grade-kruskal-wallis" = "Prueba de Kruskal-Wallis para edad al diagnostico segun grado tumoral.",
  "grade-ajcc-contingency-table-chi-squared" = "Tabla de contingencia y prueba chi-cuadrado entre grado tumoral y estadio AJCC.",
  "grade-ajcc-stacked-bar-plot" = "Grafico de barras apiladas para la distribucion del grado tumoral por estadio AJCC.",
  "grade-ajcc-conditional-probabilities" = "Calculo de probabilidades condicionadas para enfermedad avanzada y alto grado.",
  "global-kaplan-meier-curve" = "Curva de Kaplan-Meier para la supervivencia global de la cohorte.",
  "ajcc-kaplan-meier-curve" = "Curvas de Kaplan-Meier estratificadas por estadio patologico AJCC.",
  "grade-kaplan-meier-curve" = "Ajuste del modelo de Kaplan-Meier segun grado tumoral.",
  "tumor-grade-kaplan-meier-curve-plot" = "Curvas de Kaplan-Meier estratificadas por grado tumoral.",
  "age-kaplan-meier-curve" = "Curvas de Kaplan-Meier estratificadas por grupos de edad al diagnostico.",
  "sex-kaplan-meier-curve" = "Ajuste del modelo de Kaplan-Meier segun sexo biologico.",
  "sex-kaplan-meier-curve-plot" = "Curvas de Kaplan-Meier estratificadas por sexo biologico.",
  "cox-multivariate-analysis" = "Ajuste del modelo multivariante de riesgos proporcionales de Cox.",
  "simulation-code" = "Simulacion bootstrap de cohortes clinicas segun estadios avanzados.",
  "simulation-code-plot" = "Representacion grafica de la simulacion bootstrap de cohortes clinicas.",
  "inspect-transcriptomic-object" = "Carga e inspeccion inicial del objeto transcriptomico preparado.",
  "extract-count-matrix" = "Extraccion de la matriz de conteos crudos desde el objeto transcriptomico.",
  "create-counts-dataframe" = "Conversion de la matriz de conteos a un data frame para su exploracion.",
  "check-missing-values" = "Comprobacion de valores faltantes en la matriz de conteos transcriptomicos.",
  "convert-gene-identifiers" = "Conversion de identificadores Ensembl a simbolos genicos oficiales.",
  "check-sample-types" = "Comprobacion de los codigos de tipo de muestra en TCGA-KIRC.",
  "classify-sample-tissue-type" = "Clasificacion de las muestras transcriptomicas segun el tipo de tejido.",
  "create-deseq2-object" = "Construccion del objeto DESeqDataSet para el analisis diferencial.",
  "filter-low-expression-genes" = "Filtrado de genes con baja expresion antes del analisis diferencial.",
  "normalize-count-data" = "Normalizacion de conteos y ajuste del modelo estadistico con DESeq2.",
  "apply-vst-transformation" = "Aplicacion de la transformacion estabilizadora de la varianza.",
  "pca-analysis" = "Analisis de componentes principales sobre los datos transcriptomicos transformados.",
  "differential-expression-analysis" = "Analisis de expresion diferencial entre muestras tumorales y normales.",
  "heatmap-code" = "Preparacion de la matriz de expresion y configuracion del mapa de calor.",
  "heatmap-figure-render" = "Renderizado final del mapa de calor de expresion genica de los genes candidatos.",
  "clinical-transcriptomic-integration" = "Integracion de la expresion genica tumoral con los datos clinicos de supervivencia.",
  "clinical-transcriptomic-integration-table" = "Tabla resumen de los modelos de Cox univariantes para los genes candidatos.",
  "clinical-transcriptomic-integration-plot" = "Representacion grafica de los hazard ratios asociados a la expresion de los genes candidatos."
)

derive_code_title <- function(options) {
  if (!is.null(options$code_title) && nzchar(options$code_title)) {
    return(strip_trailing_code_period(options$code_title))
  }
  ...
  if (!is.null(options$label) && nzchar(options$label)) {
    if (options$label %in% names(code_titles)) {
      return(strip_trailing_code_period(unname(code_titles[[options$label]])))
    }

    label_text <- gsub("[-_]+", " ", options$label)
    label_text <- tools::toTitleCase(label_text)
    return(strip_trailing_code_period(label_text))
  }
...
knitr::knit_hooks$set(chunk = function(x, options) {
  rendered_chunk <- default_chunk_hook(x, options)

  if (!knitr::is_latex_output()) {
    return(rendered_chunk)
  }

  code_title <- derive_code_title(options)

  if (is.null(code_title) || !nzchar(code_title)) {
    return(rendered_chunk)
  }
  ...
  if (!is.null(options$label) && nzchar(options$label)) {
    code_label <- paste0("[code:", options$label, "]")
  }
  ...
  paste0(
    ...
    code_label,
    "{",
    escape_latex_code_text(code_title),
    "}\n",
    rendered_chunk,
    "\n"
  )
...
style_report_table <- function(kable_output, latex_options = "hold_position") {
  kable_output %>%
...
add_table_label <- function(kable_output, label) {
  sub(
    "(\\\\caption\\{[^}]*\\})",
    paste0("\\1\n\\\\label{", label, "}"),
    kable_output
...
\phantomsection
\addcontentsline{toc}{section}{Indice de codigos}
\listofcodes
```
...
## Bases biológicas y relevancia clínica del cáncer

El cáncer engloba un amplio conjunto de enfermedades caracterizadas por el crecimiento descontrolado de células que han acumulado alteraciones genéticas y moleculares a lo largo del tiempo. Estas alteraciones permiten que las células escapen a los mecanismos que regulan normalmente su proliferación, supervivencia y diferenciación, favoreciendo la formación de tumores capaces de invadir tejidos próximos y, en fases avanzadas, diseminarse a otros órganos mediante procesos de metástasis [@nci_dictionary_cancer_terms_2018; @weinberg_biology_cancer_2014]. Lejos de tratarse de una única enfermedad, el cáncer comprende múltiples patologías con comportamientos biológicos muy diversos, lo que explica la dificultad de su diagnóstico, tratamiento y seguimiento clínico.

Durante las últimas décadas, el estudio de la biología tumoral ha permitido identificar una serie de características comunes compartidas por la mayoría de los cánceres, conocidas como los *hallmarks of cancer* [@hanahan_2009]. Entre ellas destacan la capacidad de proliferar de forma sostenida, evitar la muerte celular programada, inducir la formación de nuevos vasos sanguíneos, evadir la respuesta inmunitaria o reprogramar el metabolismo celular para satisfacer las elevadas demandas energéticas del tumor. La adquisición progresiva de estas capacidades es consecuencia de complejas alteraciones genéticas, epigenéticas y moleculares que impulsan el desarrollo y progresión de la enfermedad [@deberardinis_metabolic_reprogramming_2008; @hanahan_2009]. A pesar de los importantes avances logrados en investigación, prevención, diagnóstico y tratamiento, el cáncer continúa representando uno de los principales desafíos para la salud pública mundial debido a su elevada incidencia y mortalidad.

## Carcinoma renal de células claras

Dentro de este grupo de enfermedades, el cáncer renal constituye una de las neoplasias urológicas más relevantes tanto por su impacto clínico como por la complejidad biológica que presenta. La mayoría de los tumores renales se originan en el epitelio tubular del riñón y se clasifican dentro del grupo de los carcinomas de células renales (*renal cell carcinoma*, RCC), responsables de aproximadamente el 90 % de las neoplasias malignas de este órgano. El RCC engloba distintos subtipos histológicos con características clínicas, moleculares y pronósticas diferenciadas, reflejando la gran heterogeneidad que caracteriza a esta enfermedad [@linehan_genetics_kidney_cancer_2010].

```{=latex}
\begin{wrapfigure}{r}{0.36\textwidth}
\centering
\vspace{-1.0\baselineskip}
\includegraphics[width=0.34\textwidth]{../assets/images/Clear_cell_renal_cell_carcinoma_high_mag.jpg}
\caption{Micrografía del subtipo más común de carcinoma de células renales (células claras), situada a la derecha de la imagen; el tejido renal no tumoral se observa a la izquierda \cite{wikipedia_renal_cell_carcinoma}.}
\label{fig:ccrcc-histology-image}
\vspace{-0.4\baselineskip}
\end{wrapfigure}
```

Entre estos subtipos, el carcinoma renal de células claras (*clear cell renal cell carcinoma*, ccRCC) es el más frecuente, representando alrededor del 70–80 % de todos los casos de RCC. Su denominación proviene del aspecto característico de las células tumorales, cuyo citoplasma presenta una apariencia clara debido a la acumulación intracelular de lípidos y glucógeno, como puede apreciarse en la Figura \ref{fig:ccrcc-histology-image}. Desde el punto de vista molecular, uno de los eventos más relevantes asociados al desarrollo de este tumor es la inactivación del gen *von Hippel–Lindau* (*VHL*), una alteración que favorece la estabilización de factores inducibles por hipoxia (*hypoxia-inducible factors*, HIF) y la activación de procesos relacionados con la angiogénesis, el metabolismo celular y la adaptación al microambiente tumoral. Sin embargo, el ccRCC es una enfermedad mucho más compleja que la simple pérdida de función de *VHL*, ya que en su desarrollo intervienen numerosas alteraciones genéticas, epigenéticas y transcriptómicas que contribuyen a su marcada heterogeneidad clínica y biológica [@linehan_genetics_kidney_cancer_2010; @cancer_genome_atlas_kirc_2013].

## Caracterización molecular del ccRCC y el proyecto TCGA

La creciente disponibilidad de tecnologías de secuenciación masiva ha transformado profundamente el estudio de esta complejidad molecular. En este contexto, iniciativas internacionales como *The Cancer Genome Atlas* (TCGA) han supuesto un punto de inflexión en la investigación oncológica al proporcionar acceso abierto a grandes colecciones de datos genómicos, transcriptómicos, epigenómicos y clínicos de miles de pacientes. Gracias a estos recursos, los investigadores pueden analizar de forma integrada distintos niveles de información biológica y explorar cómo las alteraciones moleculares se relacionan con la aparición, progresión y evolución de los tumores [@weinstein_tcga_2013].

En el caso del carcinoma renal de células claras, la cohorte TCGA-KIRC (*Kidney Renal Clear Cell Carcinoma*) constituye una de las fuentes de información más completas y ampliamente utilizadas para el estudio de esta enfermedad. La combinación de datos moleculares y clínicos disponibles en esta cohorte permite investigar asociaciones entre perfiles biológicos y variables de interés clínico, como el estadio tumoral, el grado histológico, la supervivencia o la respuesta terapéutica. Como resultado, TCGA ha contribuido significativamente a la identificación de biomarcadores y posibles dianas terapéuticas con potencial aplicación clínica [@cancer_genome_atlas_kirc_2013].

## Transcriptómica en investigación oncológica

Además de las alteraciones presentes en el genoma, los cambios en la expresión génica desempeñan un papel fundamental en el comportamiento de los tumores. La transcriptómica permite cuantificar simultáneamente la actividad de miles de genes, ofreciendo una visión global de los procesos biológicos que tienen lugar en una célula o tejido determinado. En oncología, el análisis transcriptómico se ha convertido en una herramienta esencial para identificar genes diferencialmente expresados, caracterizar subtipos moleculares, descubrir biomarcadores y comprender las rutas biológicas implicadas en la progresión tumoral. La aparición de tecnologías de secuenciación de ARN (*RNA sequencing*, RNA-seq) ha facilitado la generación de perfiles transcriptómicos de alta resolución, ampliando notablemente las posibilidades de investigación en este ámbito [@wang_rnaseq_2009].

## Bioinformática aplicada al análisis de datos oncológicos
...
## Entorno computacional y software utilizado

Todos los análisis y visualizaciones de este trabajo se realizaron en el entorno estadístico **R** versión **`r getRversion()`** (*`r R.version.string`*), sobre la plataforma **`r R.version$platform`**. El desarrollo del flujo de trabajo, la edición del código y la compilación del informe se llevaron a cabo en **RStudio 2026.05.0+218 "Golden Wattle" Release**, para macOS, con **Quarto 1.9.37** integrado en dicho entorno. El código fuente del proyecto se gestionó mediante el sistema de control de versiones **Git** y se alojó en un repositorio público de **GitHub** \href{https://github.com/Marta-Barea/tcga-kirc-bioinformatics}{\textcolor{uocblue}{tcga-kirc-bioinformatics}}.

El análisis combinó paquetes de **CRAN** y **Bioconductor** orientados a la adquisición de datos, manipulación de estructuras transcriptómicas, análisis estadístico, visualización y análisis de expresión diferencial. La Tabla \ref{tab:software-packages} resume las principales bibliotecas empleadas y sus versiones, obtenidas directamente desde la sesión de R mediante `packageVersion()` y detectadas automáticamente a partir de las llamadas a `library()` y `require()` presentes en este documento.

```{r software-environment-packages, echo=FALSE, results='asis'}
input_candidates <- c(knitr::current_input(), knitr::opts_knit$get("input.dir"))
input_candidates <- input_candidates[nzchar(input_candidates)]
...
resolve_input_path <- function(path_candidates) {
  for (candidate in path_candidates) {
    ...
    if (file.exists(file.path(getwd(), candidate))) {
      return(normalizePath(file.path(getwd(), candidate), winslash = "/", mustWork = TRUE))
    }
  }

  stop("No se pudo localizar el archivo Rmd actual para detectar los paquetes usados.")
}

input_path <- resolve_input_path(input_candidates)
rmd_lines <- readLines(input_path, warn = FALSE)

library_calls <- regmatches(
  rmd_lines,
  gregexpr("(?:library|require)\\s*\\(\\s*[[:alnum:].]+", rmd_lines, perl = TRUE)
)

software_package_names <- unique(unlist(lapply(library_calls, function(matches) {
  if (length(matches) == 0) {
    return(character(0))
  }

  sub("(?:library|require)\\s*\\(\\s*", "", matches, perl = TRUE)
})))

software_package_names <- software_package_names[nzchar(software_package_names)]

software_packages <- data.frame(
  paquete = software_package_names,
  version = vapply(
...
software_packages_latex <- knitr::kable(
  software_packages,
  format = "latex",
  booktabs = TRUE,
  row.names = FALSE,
  linesep = "",
  caption = "Principales paquetes utilizados en el flujo de trabajo y sus versiones instaladas.",
  col.names = c("Paquete", "Versión"),
  align = c("c", "c")
) %>%
  style_report_table()

software_packages_latex <- add_table_label(
  software_packages_latex,
  "tab:software-packages"
)

cat(software_packages_latex)
cat("\\FloatBarrier\n")
```

## Estrategia bioinformática seguida
...
De forma resumida, el pipeline seguido puede organizarse en las fases descritas en la Tabla \ref{tab:bioinformatics-workflow}, que sintetiza la lógica general del análisis desde la adquisición de datos hasta la integración final de resultados.

```{r bioinformatics-workflow-table, echo=FALSE, results='asis'}
library(kableExtra)

bioinformatics_workflow <- data.frame(
  fase = c(
    "Adquisición y organización de datos",
    "Preparación del conjunto clínico",
    "Análisis clínico y de supervivencia",
    "Preparación del conjunto transcriptómico",
    "Análisis transcriptómico",
    "Integración e interpretación"
  ),
  descripcion = c(
    "Consulta del proyecto TCGA-KIRC en GDC, descarga de datos clínicos y transcriptómicos, y estructuración de los archivos generados en el proyecto.",
    "Exploración inicial, evaluación de valores faltantes, filtrado de variables poco informativas, recodificación de covariables y construcción de variables de supervivencia.",
    "Obtención de estadística descriptiva, evaluación de asociaciones clinicopatológicas, análisis de Kaplan-Meier y ajuste de un modelo multivariante de Cox.",
    "Inspección de la matriz de conteos, anotación génica, clasificación de muestras por tipo de tejido y construcción del objeto preparado para el análisis diferencial.",
    "Filtrado de genes con baja expresión, normalización con DESeq2, transformación VST, análisis exploratorio mediante PCA y análisis de expresión diferencial entre tumor y tejido normal.",
    "Interpretación conjunta de los hallazgos clínicos y transcriptómicos para caracterizar la cohorte y contextualizar los resultados en el marco biológico del ccRCC."
  ),
  stringsAsFactors = FALSE
)

bioinformatics_workflow_latex <- knitr::kable(
  bioinformatics_workflow,
  format = "latex",
  caption = "Resumen del pipeline bioinformático seguido en el análisis de la cohorte TCGA-KIRC.",
  booktabs = TRUE,
  linesep = "",
  col.names = c("Fase", "Descripción"),
  align = c("l", "l")
) %>%
  style_report_table() %>%
  column_spec(1, width = "4.2cm", bold = TRUE) %>%
  column_spec(2, width = "9.6cm")

bioinformatics_workflow_latex <- add_table_label(
  bioinformatics_workflow_latex,
  "tab:bioinformatics-workflow"
)

cat(bioinformatics_workflow_latex)
cat("\\FloatBarrier\n")
```
...
```{r tcga-categories-table, echo=FALSE, results='asis'}
library(kableExtra)

tcga_categories <- data.frame(
  Categoria = c(
...
tcga_categories_latex <- knitr::kable(
  tcga_categories,
  format = "latex",
  booktabs = TRUE,
  linesep = "",
...
tcga_categories_latex <- add_table_label(
  tcga_categories_latex,
  "tab:categorias_tcga"
)

cat(tcga_categories_latex)
```
...
```{r download-script-command, eval=FALSE}
...
```{r download-script-preview, echo=FALSE, results='asis', code_title="Contenido del script de descarga y preparacion de datos TCGA-KIRC."}
...
### Exploración inicial del conjunto de datos clínico
...
```{r missingness-heatmap-figure, fig.cap="Patrón de valores faltantes en las variables clínicas del conjunto TCGA-KIRC. La leyenda indica el porcentaje total de valores presentes y faltantes.", fig.align='center', fig.width=8.2, fig.height=12.1, out.width='90%', out.height='0.80\\textheight', fig.pos='!htbp', dev='png', dpi=400}
...
```{r redundant-vars-code, results='asis'}
...
```{r categorical-descriptive-plot, fig.width=13.0, fig.height=15.8, fig.align='center', out.width='97%', out.height='0.94\\textheight', fig.pos='p', fig.cap='Distribución de frecuencias relativas de las variables categóricas del conjunto de datos clínico TCGA-KIRC.'}
...
```{r continuous-descriptive-plots-figure, fig.width=6.8, fig.height=5.8, fig.align='center', out.width='90%', fig.pos='H', fig.cap='Distribución de las variables continuas del conjunto de datos clínico TCGA-KIRC representada mediante diagrama de violín.'}
# Figura combinada
(p1 | p2) /
...
Con el fin de complementar la interpretación de la asociación observada, se calcularon probabilidades condicionadas a partir de la tabla de contingencia. En particular, se plantearon tres cuestiones de probabilidad relacionadas con la distribución conjunta del grado tumoral y el estadio patológico AJCC:

1. ¿Cuál es la probabilidad de presentar enfermedad avanzada (estadios III-IV) entre los pacientes con tumores de alto grado (G3-G4)?
2. ¿Cuál es la probabilidad de presentar un tumor de alto grado (G3-G4) entre los pacientes con enfermedad avanzada?
3. ¿Cuál es la probabilidad de presentar simultáneamente un tumor de alto grado y enfermedad avanzada dentro del conjunto total de pacientes?
...
# Probabilidad de enfermedad avanzada dado alto grado 
prob_advanced_given_high_grade <- sum( tabla_grade_stage[high_grade, advanced_stage] ) / sum(tabla_grade_stage[high_grade, ]) 

# Probabilidad de alto grado dado enfermedad avanzada 
prob_high_grade_given_advanced <- sum( tabla_grade_stage[high_grade, advanced_stage] ) / sum(tabla_grade_stage[, advanced_stage]) 

# Probabilidad conjunta de alto grado y enfermedad avanzada 
prob_high_grade_and_advanced <- sum( tabla_grade_stage[high_grade, advanced_stage] ) / sum(tabla_grade_stage) 

# Mostrar resultados en porcentaje 
probability_results <- data.frame( Cuestion = c( "P(enfermedad avanzada | alto grado)", "P(alto grado | enfermedad avanzada)", "P(alto grado y enfermedad avanzada)" ), Probabilidad = round( c( prob_advanced_given_high_grade, prob_high_grade_given_advanced, prob_high_grade_and_advanced ) * 100, 2 ) )

print(probability_results)
```

Los resultados obtenidos permiten interpretar la relación entre el grado tumoral y el estadio patológico desde una perspectiva probabilística. En primer lugar, se observó que el 56,84 % de los pacientes con tumores de alto grado (G3-G4) presentaban enfermedad avanzada (estadios III-IV), lo que indica que más de la mitad de los tumores poco diferenciados se diagnosticaron en fases avanzadas de progresión tumoral. En segundo lugar, se estimó que el 77,88 % de los pacientes con enfermedad avanzada presentaban tumores de alto grado, lo que pone de manifiesto una fuerte asociación entre ambas características clínicas. Finalmente, la probabilidad conjunta de presentar simultáneamente un tumor de alto grado y enfermedad avanzada fue del 30,17 %, indicando que aproximadamente uno de cada tres pacientes de la cohorte reunía ambas condiciones.

En conjunto, estas tres cuestiones de probabilidad complementan los resultados obtenidos mediante la prueba $\chi^2$ de independencia y refuerzan la evidencia de una asociación entre el grado tumoral y el estadio patológico. Los resultados sugieren que los tumores menos diferenciados tienden a diagnosticarse en estadios más avanzados y presentan un comportamiento clínico más agresivo.
...
```{r global-kaplan-meier-curve, fig.width=7.5, fig.height=5.5, fig.align='center', out.width='90%', fig.pos='H', fig.cap='Curva de Kaplan-Meier que muestra la supervivencia global de la cohorte TCGA-KIRC.'}
# Cargar librerías necesarias
library(survival)
library(survminer)
...
```{r ajcc-kaplan-meier-curve, fig.width=7.5, fig.height=6.2, fig.align='center', out.width='90%', fig.pos='H', fig.cap='Curvas de Kaplan-Meier estratificadas por estadio patológico AJCC, con intervalos de confianza y tabla de riesgo.'}
# Cargar librerías necesarias
library(survival)
library(viridis)
library(survminer)
...
```{r tumor-grade-kaplan-meier-curve-plot, fig.width=7.5, fig.height=6.2, fig.align='center', out.width='90%', fig.pos='H', fig.cap='Curvas de Kaplan-Meier estratificadas por grado tumoral, con intervalos de confianza y tabla de riesgo.'}
...
```{r age-kaplan-meier-curve, fig.width=7.5, fig.height=6.2, fig.align='center', out.width='90%', fig.pos='H', fig.cap='Curvas de Kaplan-Meier estratificadas por grupos de edad al diagnóstico, con intervalos de confianza y tabla de riesgo.'}
# Cargar librerías necesarias
library(survival)
library(survminer)
library(dplyr)
...
```{r sex-kaplan-meier-curve-plot, fig.width=7.5, fig.height=6.2, fig.align='center', out.width='90%', fig.pos='H', fig.cap='Curvas de Kaplan-Meier estratificadas por sexo, con intervalos de confianza y tabla de riesgo.'}
# Representar la curva de Kaplan-Meier
...
```{r simulation-code-plot, fig.width=7.5, fig.height=4.5, fig.align='center', out.width='90%', fig.pos='H', fig.cap='Distribución de la proporción de pacientes con enfermedad avanzada (estadios III-IV) obtenida a partir de 1000 cohortes simuladas mediante remuestreo bootstrap.'}
# Cargar librerías necesarias
library(ggplot2)
...
## Análisis del conjunto de datos transcriptómicos

### Exploración y preparación de los datos transcriptómicos

#### Extracción e inspección de la matriz de conteos
...
```{r inspect-transcriptomic-object}
# Cargar librerías necesarias
library(SummarizedExperiment)
...
Por este motivo, antes de realizar la exploración descriptiva del conjunto de datos, se extrajo la matriz de conteos crudos correspondiente al assay unstranded. Esta matriz contiene los genes en las filas y las muestras en las columnas, y constituye la estructura principal sobre la que se desarrollarán las etapas posteriores del análisis.
...
Los nombres de las columnas de expresión corresponden a códigos de muestra TCGA completos, por ejemplo TCGA-B8-4146-01B-11R-1672-07. Cada celda de la matriz contiene un valor entero que representa el número de lecturas asignadas a un gen concreto en una muestra determinada. Por tanto, la matriz tiene una estructura genes × muestras.
...
#### Anotación génica mediante símbolos oficiales
...
```{r convert-gene-identifiers, cache=TRUE}
# Cargar librerías necesarias
library(biomaRt)
library(dplyr)
...
cat("Genes con símbolo génico:", sum(!is.na(counts_df$gene_symbol) & counts_df$gene_symbol != ""), "\n")
cat("Genes sin símbolo génico:", sum(is.na(counts_df$gene_symbol) | counts_df$gene_symbol == ""), "\n")
cat("Porcentaje sin símbolo génico:", round(mean(is.na(counts_df$gene_symbol) | counts_df$gene_symbol == "") * 100, 2), "%\n")
...
### Preprocesamiento de los datos para el análisis de expresión diferencial

#### Creación del objeto DESeq2

Una vez explorados y preparados los datos transcriptómicos, se procedió a llevar a cabo el preprocesameinto del conjunto de datos para el análisis de expresión diferencial. Para ello, el primer paso fue la creación del objeto `DESeqDataSet` a partir de la matriz de conteos y la tabla de metadatos de muestras. Este objeto constituye la estructura principal sobre la que se desarrollará el análisis de expresión diferencial utilizando el paquete `DESeq2`, que implementa un modelo estadístico basado en la distribución negativa binomial para identificar genes diferencialmente expresados entre grupos de muestras.
...
```{r filter-low-expression-genes, cache=TRUE}
# Cargar librerías necesarias
library(DESeq2)
library(dplyr)
...
cat("Genes filtrados con símbolo:", sum(!is.na(counts_df_filtrado$gene_symbol) & counts_df_filtrado$gene_symbol != ""), "\n")
cat("Genes filtrados sin símbolo:", sum(is.na(counts_df_filtrado$gene_symbol) | counts_df_filtrado$gene_symbol == ""), "\n")
cat("Porcentaje filtrado sin símbolo:", round(mean(is.na(counts_df_filtrado$gene_symbol) | counts_df_filtrado$gene_symbol == "") * 100, 2), "%\n")
```
...
#### Normalización de los datos transccriptómicos mediante DESeq2
...
```{r normalize-count-data, cache=TRUE}
# Cargar librerías necesarias
library(DESeq2)
...
Una vez ajustado el modelo estadístico mediante `DESeq2`, se aplicó la transformación estabilizadora de la varianza (Variance Stabilizing Transformation, VST) utilizando la función `vst()`. Esta transformación reduce la dependencia existente entre la media y la varianza de los datos de expresión génica, generando valores transformados con una varianza aproximadamente constante a lo largo del rango de expresión.

```{r apply-vst-transformation, cache=TRUE}
...
```{r pca-analysis, fig.width=6.5, fig.height=4, fig.align='center', out.width='90%', fig.pos='H', fig.cap='Análisis de componentes principales (PCA) de los datos transcriptómicos transformados mediante VST, mostrando la separación entre muestras tumorales y normales.'}
# Cargar librerías necesarias
library(DESeq2)
library(ggplot2)
library(ggrepel)
...
ggplot(pca_data, aes(x = PC1, y = PC2, color =
  ...
  theme_minimal() +
  scale_color_manual(values = c("Tumor primario" = "#0B7285", "Tejido normal" = "#75D054")) +
...
### Análisis de expresión diferencial entre muestras tumorales y normales
...
```{r differential-expression-analysis, cache=TRUE, fig.width=7.5, fig.height=6, fig.align='center', out.width='90%', fig.pos='H', fig.cap='Volcanoplot de los resultados del análisis de expresión diferencial entre muestras tumorales y normales, mostrando los genes diferencialmente expresados.'}
# Cargar librerías necesarias
library(DESeq2)
library(dplyr)
library(ggplot2)
...
# Convertir los resultados a data frame, añadir símbolos génicos y clasificar genes
...
El volcano plot (Figura \ref{fig:differential-expression-analysis}) muestra claras diferencias en la expresión génica entre las muestras de carcinoma renal de células claras (ccRCC) y el tejido renal normal, lo que refleja la profunda reorganización molecular asociada a este tipo de tumor [@tcga_kirc_nature_2013].

Entre los genes más sobreexpresados destacan **CA9, NDUFA4L2, EGLN3, HILPDA y SCARB1**. La mayoría de ellos están relacionados con la respuesta celular a condiciones de baja disponibilidad de oxígeno (hipoxia), un rasgo característico del ccRCC. La elevada expresión conjunta de estos genes sugiere una fuerte activación de las rutas biológicas reguladas por los factores HIF, consideradas uno de los principales mecanismos implicados en el desarrollo de este tumor [@kaelin_vhl_kidney_cancer_2004; @schodel_hypoxia_signalling_2019].

**CA9** merece una mención especial por tratarse de uno de los marcadores más representativos del ccRCC y por aparecer de forma recurrente entre los genes más sobreexpresados en este subtipo tumoral [@bui_ca9_ccrcc_2003; @choueiri_hif2_vegf_2020]. De manera similar, la presencia de **NDUFA4L2, EGLN3 y HILPDA** refuerza la idea de que las alteraciones relacionadas con la hipoxia desempeñan un papel central en las muestras analizadas [@fu_ndufa4l2_2015; @schodel_hypoxia_signalling_2019]. Por su parte, la sobreexpresión de **SCARB1** resulta consistente con la profunda reprogramación metabólica característica del ccRCC, especialmente en relación con las alteraciones del metabolismo lipídico y del colesterol descritas para este subtipo tumoral [@linehan_genetics_kidney_cancer_2010].

También resulta interesante la sobreexpresión de **PVT1**, un ARN largo no codificante que ha sido asociado previamente con la progresión tumoral y con un peor pronóstico en pacientes con ccRCC [@zhang_pvt1_hif2a_ccrcc_2021]. Asimismo, genes como **COL23A1, CDKN2A y LINC00887** han sido relacionados con procesos relevantes para la enfermedad, incluyendo proliferación celular, progresión tumoral y modulación del microambiente inmunitario. En particular, **COL23A1** se ha asociado con una mayor agresividad tumoral y peor supervivencia en pacientes con ccRCC [@xu_col23a1_ccrcc_2017], mientras que la alteración de **CDKN2A** se relaciona con desregulación del ciclo celular y peor pronóstico clínico [@cancer_genome_atlas_kirc_2013; @zhang_cdkn2a_ccrcc_2023]. Por otra parte, el ARN largo no codificante **LINC00887** ha sido implicado en la progresión tumoral y en mecanismos de evasión inmune mediante la modulación de la actividad de linfocitos T CD8+ [@wu_linc00887_ccrcc_2022].

Por otro lado, aunque **VHL** no aparece entre los genes diferencialmente expresados más destacados, este resultado es coherente con lo esperado. En ccRCC, las alteraciones de VHL suelen producirse principalmente a nivel mutacional o funcional, por lo que la activación de genes regulados por HIF constituye una evidencia más directa de la alteración de esta vía [@kaelin_vhl_kidney_cancer_2004; @schodel_hypoxia_signalling_2019].

Finalmente, otros genes como **STC2, GABRD y TTC21B-AS1** también mostraron diferencias de expresión relevantes. Aunque su papel en ccRCC está menos establecido que el de otros genes incluidos en la firma, estos resultados sugieren que podrían representar biomarcadores o líneas de investigación de interés para futuros estudios.

### Visualización de la expresión génica mediante clustering jerárquico

Con el objetivo de explorar de forma más detallada los patrones de expresión asociados al estado tumoral, se seleccionó un subconjunto de genes candidatos a partir de los resultados del análisis de expresión diferencial. La selección se basó en los genes etiquetados en el volcanoplot, correspondientes a aquellos con mayor significación estadística y magnitud de cambio de expresión entre las muestras tumorales y las muestras de tejido renal normal.
...
```{r heatmap-figure-render, fig.width=7.5, fig.height=8, fig.align='center', out.width='90%', fig.pos='H', fig.cap='Mapa de calor de la expresión génica de los genes candidatos seleccionados a partir del análisis de expresión diferencial, mostrando la agrupación de muestras tumorales y normales.'}
# Graficar el heatmap
heatmap_plot
```
...
Con este objetivo, se evaluó la asociación entre la expresión de los genes candidatos identificados durante el análisis transcriptómico y la supervivencia global de los pacientes. Para cada gen, los individuos fueron clasificados en grupos de alta y baja expresión utilizando como punto de corte la mediana de expresión observada en las muestras tumorales primarias. Posteriormente, se ajustaron modelos de riesgos proporcionales de Cox con el fin de estimar el efecto de cada gen sobre el riesgo relativo de mortalidad.

```{r clinical-transcriptomic-integration, cache=TRUE}
# Cargar librerías necesarias
library(dplyr)
library(tibble)
library(survival)

# Identificar muestras tumorales primarias y genes candidatos con anotación disponible
...
# Construir un conjunto de datos por gen con supervivencia y expresión tumoral media por paciente
gene_survival_datasets <- lapply(integration_gene_info$gene_symbol, function(current_gene) {
  ...
  gene_expression_by_patient <- tibble(
    ...
    gene_expression = as.numeric(vst_matrix[current_gene_id, tumor_sample_metadata$sample_id])
  ) %>%
...
clinical_transcriptomic_results <- bind_rows(lapply(
  ...
  function(current_gene) {
    ...
    tibble(
      ...
      hazard_ratio = unname(gene_summary$coefficients["gene_groupHigh", "exp(coef)"]),
...
La Tabla \ref{tab:clinical-transcriptomic-integration-table} resume los resultados de los modelos de Cox univariantes ajustados para cada uno de los genes candidatos, comparando los grupos de alta y baja expresión definidos a partir de la mediana de expresión tumoral.

```{r clinical-transcriptomic-integration-table, results='asis'}
# Cargar librerías necesarias
library(kableExtra)
...
clinical_transcriptomic_results_latex <- clinical_transcriptomic_results %>%
  ...
  knitr::kable(
    ...
    linesep = "",
    caption = paste(
      "Resultados de los modelos de Cox univariantes ajustados para los genes candidatos,",
...
Con el fin de facilitar la comparación visual entre genes, en la Figura \ref{fig:clinical-transcriptomic-integration-plot} se representan los hazard ratios estimados y sus intervalos de confianza del 95 %. La línea vertical discontinua en HR = 1 indica ausencia de asociación entre el grupo de expresión y el riesgo del evento.

```{r clinical-transcriptomic-integration-plot, fig.width=7.5, fig.height=4.8, fig.align='center', out.width='92%', fig.pos='H', fig.cap='Hazard ratios estimados para los genes candidatos al comparar alta frente a baja expresión tumoral en modelos de Cox univariantes.'}
# Cargar librerías necesarias
library(ggplot2)
...
\url{https://marta-barea-sepul.shinyapps.io/tcga-kirc-explorer/}

Para ejecutarla en local desde la raíz del proyecto puede utilizarse el siguiente comando:

```{r shiny-app-run-command, eval=FALSE}
shiny::runApp("app")
```
...
```{r shiny-app-script-preview, echo=FALSE, results='asis', code_title="Contenido del script principal de la aplicacion Shiny."}
# Mostrar el contenido del script principal de la aplicacion
script_candidates <- c(
  "../app/app.R",
  "app/app.R"
)
...
if (is.na(script_path)) {
  stop(
    "No se encontro el script app/app.R.",
    call. = FALSE
  )
}
...
Concretamente, el proyecto se ha desarrollado de forma individual, lo que ha supuesto la participación directa en todas las fases del estudio, desde la adquisición y preparación de los datos hasta el análisis estadístico, bioinformático y la implementación de la aplicación Shiny. Esta circunstancia ha favorecido la consolidación de competencias relacionadas con la manipulación y depuración de datos, la programación en R, la inferencia estadística, la simulación, el análisis multivariante, la visualización de resultados y la elaboración de flujos de trabajo reproducibles. Asimismo, el desarrollo individual del proyecto ha permitido adquirir una comprensión global de cada una de las etapas del análisis y de las decisiones metodológicas adoptadas durante el estudio.
...
A pesar de los resultados obtenidos, el estudio presenta algunas limitaciones. La disponibilidad de determinadas variables clínicas es limitada y el análisis molecular realizado se ha centrado principalmente en la expresión génica. Futuras líneas de trabajo podrían incorporar análisis funcionales, estudios de enriquecimiento biológico, validaciones en cohortes independientes o modelos predictivos supervisados que permitan evaluar con mayor detalle el valor pronóstico de los biomarcadores identificados.
