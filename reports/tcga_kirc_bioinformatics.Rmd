...
Una vez completado el proceso de filtrado, recodificación y tratamiento de los valores faltantes en el conjunto clínico, se procedió a realizar un análisis estadístico descriptivo con el objetivo de caracterizar la distribución de las variables clínicas y demográficas en el cohorte TCGA-KIRC. 
...
Como puede observarse en la Figura \ref{fig:categorical-descriptive-plot}, las distribuciones gráficas son coherentes con los resultados mostrados en la Tabla \ref{tab:categorical-descriptive-statistics}. La representación visual confirma el predominio de determinadas categorías en variables relacionadas con el diagnóstico, el origen del tumor y las características demográficas de los pacientes. 

Asimismo, permite apreciar que algunas variables presentan distribuciones altamente concentradas en una única categoría, mientras que otras, especialmente las relacionadas con la estadificación tumoral y el grado histológico, muestran una mayor heterogeneidad. De este modo, la representación gráfica complementa y facilita la interpretación de los resultados descriptivos previamente expuestos para las variables categoricas del conjunto de datos clínicos de TCGA-KIRC.
