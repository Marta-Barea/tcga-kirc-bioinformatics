...
#### Cox proporcional de riesgos multivariante
...
# Comprobar distribución de pacientes y eventos por grupo de grado tumoral
table(cox_data$tumor_grade)
table(cox_data$tumor_grade, cox_data$death_event)

table(cox_data$tumor_grade_group)
table(cox_data$tumor_grade_group, cox_data$death_event)
